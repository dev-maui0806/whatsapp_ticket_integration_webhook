-- Milestone 1: Interactive Form Flow Migration
-- Add new fields to tickets table for enhanced ticket types
...
CREATE INDEX IF NOT EXISTS idx_user_form_states_customer_id ON user_form_states(customer_id);
CREATE INDEX IF NOT EXISTS idx_user_form_states_current_step ON user_form_states(current_step); 